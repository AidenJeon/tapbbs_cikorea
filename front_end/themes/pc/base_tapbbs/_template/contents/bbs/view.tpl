                    ...
                    <td colspan="4">
                        <div class="pull-right btn-group" role="group">
                            {? allowed_list.write_article === TRUE}
                                <a href="{BASE_URL}bbs/write/{bbs_id}?view_category={view_category}&amp;lists_style={lists_style}" class="btn btn-small btn-success" style="color:#fff">{lang.write}</a>
                            {/}
                            ...
                            {? allowed_list.write_article === TRUE && IS_USER_LOGIN === TRUE && view->user_idx == USER_INFO_idx}
                                <a href="{BASE_URL}bbs/modify/{bbs_id}?page={page}&amp;idx={idx}&amp;view_category={view_category}&amp;lists_style={lists_style}" class="btn btn-small btn-danger" style="color:#fff">{lang.update}/{lang.delete}</a>
                            {/}
                        </div>
                    </td>
                </tr>
