        ...
        <div class="row contact-wrap">
            <div class="status alert alert-success" style="display: none"></div>
                ...
                <div class="center form-group">
                    <button type="reset" name="reset" class="btn btn-reset btn-lg" required="required" onclick="window.location.href='/user/join';">{lang.btn_join}</button>
                    <button type="reset" name="reset" class="btn btn-reset btn-lg" required="required" onclick="window.location.href='/user/find_password';">{lang.btn_find_password}</button>
